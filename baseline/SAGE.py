from torch_geometric.nn import Linear,ChebConv, global_mean_pool, global_max_pool, GCNConv, GATConv, GraphSAGE, BatchNorm, ResGatedGraphConv
...
class GCN(torch.nn.Module):
    def __init__(self, hidden_channels=256):
        ...
        self.conv1 = GraphSAGE(140, hidden_channels, num_layers=1)
        self.conv2 = GraphSAGE(hidden_channels, 32, num_layers=1)
